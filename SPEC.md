...
- Terminal-state workspace cleanup is handled by startup cleanup, hourly terminal sweeps,
  active-run reconciliation, and retry refreshes that observe a terminal transition.
